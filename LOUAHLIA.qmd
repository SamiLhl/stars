...
```{r Q7}
planet_terrain <- Main_Data |> select(PLANET_NUMBER, `type of terrain`, `type of climate`) |> reframe(PLANET_NUMBER,
  str_split(Main_Data$`type of terrain`,"," ))
planet_climate <- Main_Data |> select(PLANET_NUMBER, `type of terrain`, `type of climate`) |> reframe(PLANET_NUMBER,
  str_split(Main_Data$`type of climate`, ","))
